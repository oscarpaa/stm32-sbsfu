...
@par Directory contents
   ...
   - 2_Images_SBSFU/Core/Src/stm32g0xx_hal_msp.c              HAL MSP module
   - 2_Images_SBSFU/Core/Src/stm32g0xx_it.c                   STM32 interrupt handlers
   ...
   - 2_Images_SBSFU/Core/Inc/stm32g0xx_hal_conf.h             HAL configuration file
   - 2_Images_SBSFU/Core/Inc/stm32g0xx_it.h                   Header file for stm32g0xx_it.c
   ...
   - 2_Images_SBSFU/SBSFU/App/sfu_fwimg_state.h               Secure Firmware Update image state handling
   ...
   - 2_Images_SBSFU/SBSFU/App/sfu_mpu_isolation.c             Secure Engine isolation with MPU (when no Firewall is available)
   ...
   - 2_Images_SBSFU/SBSFU/App/sfu_mpu_isolation.h             Header file for sfu_mpu_isolation.c
