...
#define SFU_NB_PAGE_SEC_USER_MEM ((uint32_t)(((SFU_SEC_MEM_AREA_ADDR_END - FLASH_BASE) / FLASH_PAGE_SIZE) + 1U))



/*!< Area A  used to protect Vector Table*/
#define SFU_PROTECT_WRP_AREA_1          (OB_WRPAREA_ZONE_A)
...
#define SFU_PROTECT_PCROP_AREA          (OB_PCROP_ZONE_A)                         /*!< PCROP Area */
...
/**
  * @brief Region 2 - The Aliases Region and all User Flash & internal RAM. When executing inside SB/SFU by default all
  ...
  */
#define SFU_PROTECT_MPU_AREA_USER_RGNV  MPU_REGION_NUMBER2
...
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0x80U               /*!< 64 Kbytes / 8 * 7 ==> 56 Kbytes */
#elif defined (__GNUC__)
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0x80U               /*!< 64 Kbytes / 8 * 7 ==> 56 Kbytes */
#else
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0x80U               /*!< 64 Kbytes / 8 * 6 ==> 56 Kbytes */
...
#define SFU_PROTECT_MPU_HEADER_SIZE  MPU_REGION_SIZE_2KB
...
/**
  * @brief Region 5 - Inner region inside the Region 2 . The Option Bytes. Once the Option Bytes have been set,
 ...
 * [ 1FFF7800 1FFF7808 1FFF7810 1FFF7818 1FFF7820 .. 1FFF7878]: 128 bytes to be protected
 ...
 */
#define SFU_PROTECT_MPU_AREA_OB_BANK1_RGNV  MPU_REGION_NUMBER5
#define SFU_PROTECT_MPU_AREA_OB_BANK1_START ((uint32_t)0x1FFF7800U) /*!< Option Bytes in bank 1        */
#define SFU_PROTECT_MPU_AREA_OB_BANK1_SIZE  MPU_REGION_SIZE_256B
#define SFU_PROTECT_MPU_AREA_OB_BANK1_SREG  0xF0                    /*!< 256 bytes / 8 * 4 ==> 128 bytes */
#define SFU_PROTECT_MPU_AREA_OB_BANK1_PERM  MPU_REGION_NO_ACCESS
#define SFU_PROTECT_MPU_AREA_OB_BANK1_EXECV MPU_INSTRUCTION_ACCESS_DISABLE
#define SFU_PROTECT_MPU_AREA_OB_BANK1_TEXV  MPU_TEX_LEVEL0
#define SFU_PROTECT_MPU_AREA_OB_BANK1_B     MPU_ACCESS_NOT_BUFFERABLE
#define SFU_PROTECT_MPU_AREA_OB_BANK1_C     MPU_ACCESS_CACHEABLE
...
/**
  * @brief Region 6 - Second configuration ==> Enable execution in privileged mode for Secure Memory RAM code area.
  *                   Read only capability configured
...
#define SFU_PROTECT_MPU_SRAM_HDP_SIZE  MPU_REGION_SIZE_512B
