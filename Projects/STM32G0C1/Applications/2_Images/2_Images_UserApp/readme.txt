...
@par Directory contents
   ...
   - 2_Images_UserApp/Src/stm32g0xx_it.c             Interrupt handlers
   - 2_Images_UserApp/Src/system_stm32g0xx.c         STM32 system file
   ...
   - 2_Images_UserApp/Inc/stm32g0xx_conf.h           HAL configuration file
   - 2_Images_UserApp/Inc/stm32g0xx_it.h             Header for stm32g0xx_it.c file
...
2. Pressing 2 allows to test protections.
   ...
   - TAMPER test (#4): causes a reset if a tamper event is detected. In order to generate a tamper event, user has to
     connect PA0 (CN7.28) to GND (It may be enough to put your finger close to PA0 (CN7.28)). It may be better to
     have PA0 (CN7.28) connected to 3V3 before doing the transition to GND.
