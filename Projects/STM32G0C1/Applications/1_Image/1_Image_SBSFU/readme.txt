...
@par Directory contents
   ...
   - 1_Image_SBSFU/Core/Src/main.c                           Main application file
   - 1_Image_SBSFU/Core/Src/stm32g0xx_hal_msp.c              HAL MSP module
   - 1_Image_SBSFU/Core/Src/stm32g0xx_it.c                   STM32 interrupt handlers
   - 1_Image_SBSFU/Core/Inc/app_hw.h                         Hardware definitions for application
   - 1_Image_SBSFU/Core/Inc/main.h                           Header file for main.c
   - 1_Image_SBSFU/Core/Inc/stm32g0xx_hal_conf.h             HAL configuration file
   - 1_Image_SBSFU/Core/Inc/stm32g0xx_it.h                   Header file for stm32g0xx_it.c
   - 1_Image_SBSFU/SBSFU/App/sfu_boot.c                      Secure Boot (SB): entry/exit points and state machine
   - 1_Image_SBSFU/SBSFU/App/sfu_com_loader.c                SBSFU communication module: local loader part
   - 1_Image_SBSFU/SBSFU/App/sfu_com_trace.c                 SBSFU communication module: trace part
   - 1_Image_SBSFU/SBSFU/App/sfu_error.c                     SBSFU errors management
   - 1_Image_SBSFU/SBSFU/App/sfu_fwimg_common.c              SBSFU image handling: common functionalities/services
   - 1_Image_SBSFU/SBSFU/App/sfu_loader.c                    SBSFU Local Loader
   - 1_Image_SBSFU/SBSFU/App/sfu_mpu_isolation.c             Secure Engine isolation with MPU (when no Firewall is available)
   - 1_Image_SBSFU/SBSFU/App/sfu_new_image.c                 SBSFU image handling: new image storage and installation request
   - 1_Image_SBSFU/SBSFU/App/sfu_test.c                      SBSFU security protection automatic test
   - 1_Image_SBSFU/SBSFU/App/app_sfu.h                       Software configuration of SBSFU application
   - 1_Image_SBSFU/SBSFU/App/sfu_boot.h                      Header file for sfu_boot.c
   - 1_Image_SBSFU/SBSFU/App/sfu_com_loader.h                Header file for sfu_com_loader.c
   - 1_Image_SBSFU/SBSFU/App/sfu_com_trace.h                 Header file for sfu_com_trace.c
   - 1_Image_SBSFU/SBSFU/App/sfu_def.h                       General definition for SBSFU application
   - 1_Image_SBSFU/SBSFU/App/sfu_error.h                     Header file for sfu_error.c file
   - 1_Image_SBSFU/SBSFU/App/sfu_fsm_states.h                SBSFU FSM states definitions
   - 1_Image_SBSFU/SBSFU/App/sfu_fwimg_internal.h            Internal definitions for firmware image handling
   - 1_Image_SBSFU/SBSFU/App/sfu_fwimg_regions.h             FLASH regions definitions for image handling
   - 1_Image_SBSFU/SBSFU/App/sfu_fwimg_services.h            Header file for sfu_fwimg_services.c
   - 1_Image_SBSFU/SBSFU/App/sfu_loader.h                    Header file for sfu_loader.c
   - 1_Image_SBSFU/SBSFU/App/sfu_mpu_isolation.h             Header file for sfu_mpu_isolation.c
   - 1_Image_SBSFU/SBSFU/App/sfu_new_image.h                 Header file for sfu_new_image.c
   - 1_Image_SBSFU/SBSFU/App/sfu_standalone_loader.h         Interface through shared memory with standalone loader
   - 1_Image_SBSFU/SBSFU/App/sfu_test.h                      Header file for sfu_test.c
   - 1_Image_SBSFU/SBSFU/App/sfu_trace.h                     Header file for sfu_trace.c
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level.c              SBSFU general low level interface
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level_flash.c        SBSFU flash low level interface (wrapper)
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level_flash_int.c    SBSFU internal flash low level interface
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level_flash_ext.c    SBSFU external flash low level interface
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level_security.c     SBSFU security low level interface
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level.h              Header file for general low level interface
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level_flash.h        Header file for flash low level interface (wrapper)
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level_flash_int.h    Header file for internal flash low level interface
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level_flash_ext.h    Header file for external flash low level interface
   - 1_Image_SBSFU/SBSFU/Target/sfu_low_level_security.h     Header file for security low level interface

@par Hardware and Software environment

   - This example runs on STM32G0C1xx devices.
   - This example has been tested with NUCLEO-G0C1RE board and can be easily tailored to any other supported device and
     development board.
